...
# Clean barretenberg.
rm -rf ../dependencies/barretenberg/cpp/build
rm -rf ../dependencies/barretenberg/cpp/build-wasm
rm -rf ../dependencies/barretenberg/cpp/src/wasi-sdk-*

# Install formatting git hook.
HOOKS_DIR=$(git rev-parse --git-path hooks)
echo "cd \$(git rev-parse --show-toplevel)/cryptography-engineer && ./format.sh staged" > $HOOKS_DIR/pre-commit
...
(cd dependencies/barretenberg/cpp/srs_db && ./download_ignition.sh 3)
